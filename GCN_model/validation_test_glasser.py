...
def main(hemisphere, sub, subdir_path, modelpath):
    ...
    savepath = '{}/{}.glasserindi.MSM_weighted.{}.label.gii'.format(subdir_path[0], sub, FLAGS.hemisphere)
...
if __name__=='__main__':
    ...
    flags.DEFINE_string('subdir', '/n04dat01/atlas_group/lma/HCP_S1200_individual_MSM_atlas/994273', 'cerebral cortex part')
    # os.environ["CUDA_VISIBLE_DEVICES"] = FLAGS.card


    
    modelpath = '/n04dat01/atlas_group/lma/populationGCN/BAI_Net/BAI-Net_MSM/tf_glasser_0_1_{}/'.format(FLAGS.hemisphere)
