...
if __name__=='__main__':
    ...
    flags = tf.app.flags
    FLAGS = flags.FLAGS
    flags.DEFINE_string('dataset', '/n04dat01/atlas_group/lma/HCP_test_retest/MSM/HCP_test', 'Dataset string.')  # 'cora', 'citeseer', 'pubmed'
    flags.DEFINE_string('modeldir', '/n04dat01/atlas_group/lma/populationGCN/BAI_Net/GCN_model/tf_BNA_0_5_L/', 'Dataset string.')
    ...
    flags.DEFINE_string('subdir', 'None', 'cerebral cortex part')
    flags.DEFINE_string('sublist', 'None', 'cerebral cortex part')
